...
function showResultBox() {
    ...
    if(userScore > 3){
        let scoreTag = '<span>and congrats!, You got <p>' + userScore + '</p> out of <p>5</p>Questions</span>';
        scoreText.innerHTML = scoreTag;
    }
    if(userScore > 1){
        let scoreTag = '<span>and nice, You got <p>' + userScore + '</p> out of <p>5</p>Questions</span>';
        scoreText.innerHTML = scoreTag;
    }
    else{
        let scoreTag = '<span>and sorry, You got only <p>' + userScore + '</p> out of <p>5</p>Questions</span>';
        scoreText.innerHTML = scoreTag;
    }
}
